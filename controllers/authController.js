...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  //TODO: This code will be removed and use the code above instead due to security and remove the passwordConfirm, passwordCreatedAt and the role of the user
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // select method means we want to show password
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  // 3. If the password currect, update password
  user.password = req.body.password;
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
